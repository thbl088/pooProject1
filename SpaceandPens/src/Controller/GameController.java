...
import Model.Map;
import Model.Npc;
import Model.WorldIHM;
import Model.Door;
import Model.LockedDoor;
import Model.Player;
...
public class GameController implements Initializable {
    ...
    public void openFight(MouseEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/View/fight.fxml"));
   ...
   public Object[] actionGo(String direction) { //déplace le joueur sur le monde
    ...
    public void openShop(MouseEvent event) throws IOException {
        ...
        shopController.setPlayerAndShop(this.world.getPlayer(), (Model.Shop) this.world.getPlayer().getMapHero().getShop().getDestination());
    ...
    public void openTalk(MouseEvent event, String nameNpc) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/View/Talk.fxml"));
        Parent root = loader.load();
    ...
    public void openWindowEndPortal(MouseEvent event) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/View/endDoor.fxml"));
        Parent root = loader.load();
